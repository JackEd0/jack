...
<div class="col-lg-8">
    ...
    <form method="POST" action="/contact" id="contact_form">
        <div class="form-group mt">
            ...
            <input disabled type="text" class="form-control" id="InputName1" name="name" required="">
        </div>
        <div class="form-group">
            <label for="InputEmail1"><?php echo _l('email') ?> *</label>
            <input disabled type="email" class="form-control" id="InputEmail1" name="email" required="">
        </div>
        <div class="form-group">
            <label for="InputSubject1"><?php echo _l('subject') ?></label>
            <input disabled type="text" name="subject" class="form-control" id="InputSubject1">
        </div>
        <div class="form-group">
            <label for="message1"><?php echo _l('message') ?> *</label>
            <textarea disabled class="form-control" id="message1" rows="3" name="message" required=""></textarea>
        </div>
        <button disabled type="submit" class="btn btn-theme"><?php echo _l('submit') ?></button>
    </form>
</div>
<?php
